...
assert_checkerror("mdaq_ai_scan_init(1, [-10.24 10.24], %F, 500001, 1)", "Unsupported range") // BUG 

case 7
assert_checkerror("mdaq_ai_read(1:9, [-10.24 10.24], %F)", "Wrong AI channel selected!")
assert_checkerror("mdaq_ai_scan_init(1, [-10.24 10.24], %F, 1000001, 1)", "Unsupported range") // BUG 
...
case 10
assert_checkerror("mdaq_ai_scan_init(1, [-10.24 10.24], %F, 2000001, 1)", "Unsupported range") // BUG    
