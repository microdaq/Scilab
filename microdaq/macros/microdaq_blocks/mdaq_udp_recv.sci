function [x,y,typ] = mdaq_udp_recv(job,arg1,arg2)
    tcp_recv_desc = ["UDP Receive block";
    "Receive data over UDP network. ";
    ...
    "Data type: not supported (default uint8)";
    "   1 - real";
    "   3 - int32";
    "   4 - int16";
    "   5 - int8";
    ...
    case 'define' then
        ...
        tcp_timeout = 10;
        model=scicos_model()
        model.sim=list('mdaq_udp_recv_sim',5)
        model.in =[]
        model.out=data_size;
        model.out2=1;
