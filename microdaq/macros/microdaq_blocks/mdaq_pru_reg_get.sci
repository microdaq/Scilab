function [x,y,typ] =mdaq_pru_reg_get(job,arg1,arg2)
    pru_reg_desc = ["This block reads MicroDAQ PRU real-time";
    "execution unit register.";
    "";
    "output(1) - PRU register value (uint32)";
    "";
    "PRU register: 0...15";
    "";
    ...
    case 'define' then
        ...
        pru_core = 0;
        model=scicos_model()
        model.sim=list('mdaq_pru_reg_get_sim',5)
        model.in =[]
        model.outtyp=1
        model.out=1
        model.out2=1
